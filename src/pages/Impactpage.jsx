    ...
    return (
        <div className=''>
            ...
            <div className="text-center mt-24 mb-10 max-w-xl mx-auto" data-aos="zoom-in" data-aos-offset="50">
                <h3 className="text-3xl font-Karla font-extrabold text-green-900 mb-6 drop-shadow-sm">
                    Become a Member
                </h3>
                <Link to="/network-members#register"
                    className="inline-block bg-green-700 font-Karla hover:bg-green-800 text-white font-bold text-lg px-12 py-4 rounded-full shadow-xl transition transform hover:scale-105"
                >
                    Register Now
                </Link>
            </div>
