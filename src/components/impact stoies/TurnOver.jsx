  ...
  return (
    <div className="bg-white container mx-auto py-16 px-6 grid place-items-center">
      ...
      <div className="flex-1 font-Nunito  mt-10" data-aos="fade-right">
        <h2 className="md:text-4xl font-bold text-xl text-green-700 tracking-wide mb-4 font-Nunito ">
          Impact on Varietal Turnover
        </h2>
        <p className="mb-4 text-gray-900 text-base font-Karla leading-relaxed">
        ...
        <p className="mt-8 border-l-4 border-green-700 pl-4 text-green-800 font-bold font-karla text-lg" data-aos="fade-up">
